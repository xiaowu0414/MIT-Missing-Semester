...
For example, the tree for the example directory structure [above](#snapshots) (visualized using `git cat-file -p 698281bc680d1995c5f4caaf3359721a5a58d48d`), looks like this:  
例如， [上面](#snapshots)示例目录结构的树状图。 （使用 `git cat-file -p 698281bc680d1995c5f4caaf3359721a5a58d48d` 可视化）如下所示：
...
[Edit this page](https://github.com/missing-semester/missing-semester/blob/master/_2020/version-control.md).
